...
- [x] Update hero stats
- [x] Update trust signals
- [x] Update proof strip
- [x] Expand workflow steps (3 → 5)
- [x] Expand feature cards (4 → 8)
- [x] Update pricing (geo-pricing, features)
- [x] Expand FAQ (3 → 7 questions)
