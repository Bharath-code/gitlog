...
1. **Morning standup:** Open [`PHASE2_PROGRESS.md`](./PHASE2_PROGRESS.md)
2. **Starting a task:** Check [`PHASE2_IMPLEMENTATION_PLAN.md`](./PHASE2_IMPLEMENTATION_PLAN.md) for acceptance criteria
3. **Technical questions:** Reference [`PHASE2_TECHNICAL_SPECS.md`](./PHASE2_TECHNICAL_SPECS.md)
4. **Quick lookup:** Use [`PHASE2_QUICK_REF.md`](./PHASE2_QUICK_REF.md)

### For Weekly Reviews

1. Update [`PHASE2_PROGRESS.md`](./PHASE2_PROGRESS.md) with completed tasks
2. Review metrics against targets
3. Update sprint timeline
4. Identify blockers

### For Stakeholder Updates

1. Share [`PHASE2_SUMMARY.md`](./PHASE2_SUMMARY.md) for business context
2. Show progress from [`PHASE2_PROGRESS.md`](./PHASE2_PROGRESS.md)
3. Reference metrics dashboard
...
3. ✅ Set up Mailchimp account
4. ✅ Add environment variables to `.env.local`
5. ✅ Install new dependencies

### Week 1 (Mar 9-15)

1. Start W-01: Widget script generator
2. Complete W-02: Embeddable iframe component
3. Work on W-03: Widget customization
4. Update progress daily in [`PHASE2_PROGRESS.md`](./PHASE2_PROGRESS.md)
