      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-muted">
          <section>
            ...
            <p>
              By accessing and using GitLog ("the Service"), you accept and agree to be bound by 
          ...
          <section>
            ...
            <p>
              GitLog auto-generates changelogs from GitHub pull requests. The Service provides:
            </p>
          ...
          <section>
            ...
            <p>
              To use the Service, you must sign in with your GitHub account. You are responsible 
              for maintaining the security of your GitHub account and for all activities that 
          ...
          <section>
            ...
            <p>
              ...
              GitLog and are protected by international copyright, trademark, and other 
          ...
          <section>
            ...
            <p>
              ...
              Service, you grant GitLog a license to use, store, and display your content solely 
          ...
          <section>
            ...
            <p>
              The Service offers both free and paid plans. Paid plans are billed monthly through 
              our payment processor DodoPayment. You can cancel your subscription at any time.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We offer a 14-day money-back guarantee for paid plans. If you're not satisfied 
              with the Service, contact us within 14 days of purchase for a full refund.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              GitLog shall not be liable for any indirect, incidental, special, consequential, 
