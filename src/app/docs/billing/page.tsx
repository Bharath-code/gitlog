      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <Card className="p-6 space-y-6">
            <div>
              ...
              <p className="text-sm text-muted mt-2">or $0/month for international users</p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2">
                {['No priority support', 'No custom domains', 'No analytics'].map(
                  (limitation, i) => (
                    <li key={i} className="flex items-start gap-2 text-sm">
          ...
          <Card className="p-6 space-y-6 relative border-accent/50 shadow-lg shadow-accent-glow/10">
            ...
            <div>
              ...
              <p className="text-sm text-muted mt-2">or $19/month for international users</p>
            </div>
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4 text-muted">
            <p>
              We take security seriously. All payments are processed securely by DodoPayment, a PCI
              DSS compliant payment processor.
            </p>
            <ul className="space-y-2">
        ...
        <Card className="p-6">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="font-semibold mb-2">How does pricing work for international users?</h3>
            ...
            <div>
              ...
              <p className="text-muted">
                ...
                users. Payments are processed securely by DodoPayment.
              </p>
            </div>
            ...
            <div>
              <h3 className="font-semibold mb-2">Do you offer discounts for open source?</h3>
              <p className="text-muted">
                Yes! Popular open source projects (100+ stars) get Pro for free. Email us at{' '}
            ...
            <div>
              <h3 className="font-semibold mb-2">What happens if I hit the free plan limit?</h3>
              <p className="text-muted">
                You'll see an upgrade prompt. Your existing entries stay published, but you can't
                publish new entries until you upgrade to Pro or the next month begins (limits reset
                monthly).
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted">
                Yes! We offer a 14-day money-back guarantee. If you're not satisfied, email us
