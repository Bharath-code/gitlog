    ...
    >
      <div className="max-w-2xl">
        ...
        <p className="body-balance mt-5 text-lg leading-8 text-muted">
          Choose how and when to publish. From per-PR to monthly digests, GitLog adapts to your
          workflow.
        </p>
      </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="mt-3 text-base leading-relaxed text-muted">
              Beautiful emails sent automatically. When you publish, subscribers are notified.
              Professional HTML templates, grouped by category, with "View Online" links and
