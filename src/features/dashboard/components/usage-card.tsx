...
export function UsageCard({ plan, usage }: UsageCardProps) {
  ...
  const entriesPercent = limits.entriesPerMonth === Infinity
    ? 0
        ...
        <div>
          ...
          <div className="mt-3 space-y-2">
            <div>
              <div className="flex items-center justify-between text-sm mb-1">
                ...
                <span className="font-medium">
                  {usage.entriesPublished} / {limits.entriesPerMonth === Infinity ? '∞' : limits.entriesPerMonth}
                </span>
              </div>
            ...
            <div className="flex items-center gap-4 text-xs text-muted">
              ...
              <span>•</span>
              <span>
                {usage.aiRewrites} AI rewrites used
              </span>
            </div>
          </div>
        </div>
